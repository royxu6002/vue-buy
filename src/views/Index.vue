...
.header-container .logo-right span {
	padding-left: 10px;
}
.logo-right{
	width: 400px;
...
.logo-container a{
	...
	height: 100px;
	border-radius: 50%;
	background: #fff url(../assets/images/logo.png) no-repeat center/50%;
}
.logo-container{
	top: 0px;
	left: 50px;
